export default function handler(req, res) {
  ...
  const { month, college, tuition_start, tuition_end, day } = req.body;
  ...
  if (day !== "Sunday") {
    if (college) schedule.push({ task: "College", start: "07:00 AM", end: "01:15 PM" });
    ...
    if (tuition_start && tuition_end) {
      ...
      const studyStartMinutes = college ? (13*60+15)+30 : 6*60; // 6:00 AM if no college
      ...
      const studyStartMinutes = college ? (13*60+15)+30 : 6*60;
